...
**❌ Don't Do This:**
```python
# You start typing in src/{{ package_name }}/math_utils.py
...
# NOW go to src/{{ package_name }}/math_utils.py
...
```
src/{{ package_name }}/  # Implementation code
...
# 5. Open src/{{ package_name }}/validators.py
