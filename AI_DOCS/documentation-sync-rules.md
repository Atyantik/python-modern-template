...
This project supports **6 AI agents** across **multiple documentation locations**:

### AI Agents
1. **Claude Code** - CLAUDE.md + .claude/
2. **Cursor IDE** - .cursorrules
3. **Aider AI** - .aider.conf.yml
4. **Gemini Code Assist** - .gemini/styleguide.md + AGENTS.md
5. **GitHub Copilot** - .github/copilot-instructions.md
6. **Universal** - AGENTS.md
...
| Gemini (universal) | `AGENTS.md` | ✅ Yes (`@AI_DOCS/`) | Auto-reference |
| Gemini (style) | `.gemini/styleguide.md` | ❌ No | Manual duplicate + warning |
...
- [ ] `AGENTS.md` (universal)
- [ ] `.gemini/styleguide.md` (Gemini-specific)
...
For agents that **support references** (Claude, Cursor, Aider, Gemini/AGENTS.md):
...
For agents that **don't support references** (Gemini/styleguide, Copilot):
...
│
├── .gemini/
│   └── styleguide.md                  # Gemini-specific (manual sync + warning)
│
├── .github/
│   └── copilot-instructions.md        # Copilot-specific (manual sync + warning)
│
├── .claude/
